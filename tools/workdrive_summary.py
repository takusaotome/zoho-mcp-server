...
class WorkDriveSummary:
    ...
    async def _show_team_folder_info(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.log(f"✅ Team Folder取得成功", "SUCCESS")
    ...
    async def _show_workspace_info(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.log(f"✅ ワークスペース情報取得", "SUCCESS")
                self.log(f"   成功エンドポイント: {successful_endpoints}個")
    ...
    async def _show_overall_assessment(self):
        ...
        self.log(f"   📁 Workspace: hui9647cb257be9684fe294205f6519388d14")
        self.log(f"   📂 Team Folder: \"for Redac\" (c8p1g470d8763a60b44ccb6785386f38a1bed)")
        self.log(f"   🏷️  Team: ntvsh862341c4d57b4446b047e7f1271cbeaf")
