...
class BDDTestRunner:
    ...
    def scenario_task_creation_and_verification(self):
        ...
        try:
            with httpx.Client(timeout=30.0):
                ...
                self.make_mcp_request("callTool", params, "bdd_create_task")
                ...
                self.make_mcp_request("callTool", list_params, "bdd_list_tasks")
    ...
    def scenario_task_status_update(self):
        ...
        try:
            ...
            self.make_mcp_request("callTool", params, "bdd_update_task")
            ...
            self.make_mcp_request("callTool", summary_params, "bdd_summary")
    ...
    def scenario_task_detail_retrieval(self):
        ...
        try:
            ...
            self.make_mcp_request("callTool", params, "bdd_detail")
    ...
    def scenario_project_summary(self):
        ...
        try:
            ...
            self.make_mcp_request("callTool", params, "bdd_summary_detail")
    ...
    def scenario_error_handling(self):
        ...
        try:
            ...
            self.make_mcp_request("callTool", params, "bdd_error_test")
    ...
    def scenario_file_search(self):
        ...
        try:
            ...
            self.make_mcp_request("callTool", params, "bdd_search_files")
    ...
    def scenario_file_download(self):
        ...
        try:
            ...
            self.make_mcp_request("callTool", params, "bdd_download_file")
    ...
    def scenario_file_upload(self):
        ...
        try:
            ...
            self.make_mcp_request("callTool", params, "bdd_upload_file")
