...
class PerformanceTestRunner:
    ...
    def test_response_time_sla(self):
        ...
        self.log("📊 Response Time Statistics:")
    ...
    def test_concurrent_requests(self):
        ...
        if response_times:
            ...
            self.log("📊 Concurrent Request Statistics:")
    ...
    def test_sustained_load(self):
        ...
        self.log("📊 Sustained Load Statistics:")
    ...
    def test_memory_efficiency(self):
        ...
        self.log("📊 Memory Efficiency Statistics:")
    ...
    def test_error_rate_under_load(self):
        ...
        self.log("📊 Error Rate Statistics:")
